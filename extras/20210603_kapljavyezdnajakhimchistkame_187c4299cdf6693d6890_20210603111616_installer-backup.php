...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210603_kapljavyezdnajakhimchistkame_187c4299cdf6693d6890_20210603111616_archive.zip';
    const ARCHIVE_SIZE       = '711549642';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '187c429-03111616';
    const SECONDARY_PACKAGE_HASH = 'a31413d-03111616';
