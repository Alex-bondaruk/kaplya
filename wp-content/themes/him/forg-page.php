...
<?php 
if( have_rows('org_serv') ):
?>
        <div class="org_items">
<?php while( have_rows('org_serv') ): the_row(); 
    $org_serv_bg = get_sub_field('org_serv_bg');
    $org_serv_title = get_sub_field('org_serv_title');
    $org_serv_link = get_sub_field('org_serv_link');
?>
            <div class="org_item" style="background: url(<?php echo $org_serv_bg['url']; ?>);">
                <a href="<?php echo $org_serv_link; ?>"><span><?php echo $org_serv_title; ?></span></a>
            </div>
<?php endwhile; ?>
        </div> 
        <?php endif; ?> 
...
<?php endwhile; ?>
    ...
    <div class="s2 section services_items" style="padding: 50px 0;">
        <div class="wrapper">
