...
<noscript><div><img src="https://mc.yandex.ru/watch/80275114" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
    <header>  
...
if( !empty($logo) ): ?>
                        <a href="<?php if(empty($_SESSION['urlCurrentSite'])){ echo get_home_url();} else {echo $_SESSION['urlCurrentSite'];} ?>"><img src="<?php echo $logo['url']; ?>" alt="logo"></a>
<?php endif; ?>
                    </div>
    ...
    <div class="mob_menu">
        <div class="wrapper">
            <div class="mob_menu_row1">
                <div class="logo">
                    <a href="<?php echo get_home_url(); ?>"><img src="/wp-content/uploads/2020/10/logo2-1.svg" alt="logo"></a>
                </div>
    ...
    <div id="detect-town">
      <div class="wrapper">
        <div class="detect-town-inner">
          <div class="detect-town-title">Ваш город - <span><?php echo get_option( 'options_city_for_list' ); ?>?</span></div>
