!function (e) {
    ...
    var p = function (e) {
        var t = wpcf7.api, n = 'https://reflection-web.ru/wp-json/', r = t.namespace, o = void 0 === r ? "contact-form-7/v1" : r;//n = t.root
        return d.reduceRight((function (e, t) {
            return function (n) {
                return t(n, e)
            }
        }), (function (e) {
            var t, r, c = e.url, a = e.path, i = e.endpoint, s = e.headers, f = e.body, p = e.data,
    ...
    function g(e) {
        ...
        e.wpcf7 = {
            ...
            var t = function (e, t) {
                var n = c(e.getAttribute("data-starting-value")), r = c(e.getAttribute("data-maximum-value")),
